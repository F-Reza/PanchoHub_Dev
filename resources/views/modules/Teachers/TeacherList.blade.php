<x-dashboard-app-layout>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="#" class="btn btn-primary px-4" data-toggle="modal"
                                    data-target="#createTeacherModal">Create</a>
                            </div>
                                            ...
                                            @if ($teachers->isNotEmpty())
                                                @foreach ($teachers as $key => $teacher)
                                                    <tr>
                                                        ...
                                                        <td class="align-left" style=" max-width: 250px;"> {{ $teacher->name }} </td>
                                                        <td class="align-left"> {{ $teacher->category }} </td>
                                                        <td class="align-left"> {{ $teacher->contact }} </td>
                                                        <td class="align-left"> {{ $teacher->upazila }} </td>
                                                        <td class="align-left"> {{ $teacher->user->name ?? 'N/A' }}</td>
                                                        <td class="align-left">
                                                        ...
                                                        <td>
                                                            <a href="#" class="btn btn-success"
                                                                ...
                                                                data-id="{{ $teacher->id }}"
                                                                data-user="{{ $teacher->user->name }}"
                                                                data-name="{{ $teacher->name }}"
                                                                data-title="{{ $teacher->title }}"
                                                                data-category="{{ $teacher->category }}"
                                                                data-contact="{{ $teacher->contact }}"
                                                                data-classess="{{ $teacher->classess }}"
                                                                data-subjects="{{ $teacher->subjects }}"
                                                                data-time_period="{{ $teacher->time_period }}"
                                                                data-gender="{{ $teacher->gender }}"
                                                                data-salary="{{ $teacher->salary }}"
                                                                data-upazila="{{ $teacher->upazila }}"
                                                                data-address="{{ $teacher->address }}"
                                                                data-status="{{ $teacher->status }}"
                                                                data-image="{{ $teacher->image ? asset('uploads/teachers/' . $teacher->image) : '' }}"
                                                                data-entry="{{ \Carbon\Carbon::parse($teacher->created_at)->format('d/m/Y') }}">
                                                                View
                                                            </a>
    ...
    <div class="modal modalz fade" id="createTeacherModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered custom-modal-width" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('admin.teachers.store') }}" id="modalForm" enctype="multipart/form-data">
                @csrf
    ...
    <!-- Edit Teacher Modal -->
    <div class="modal modalz fade" id="editTeacherModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered custom-modal-width" role="document">
            <div class="modal-content">
            ...
            <form method="POST" action="" id="modalFormX" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">শিক্ষক ডাটা পরিবর্তন </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <!-- View Teacher Modal -->
    <div class="modal modalz fade" id="viewTeacherModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered custom-modal-width" role="document">
            <div class="modal-content">
                <div class="modal-header">
                                        ...
                                        <div class="p-2 flex-grow-1 bd-highlight">
                                            ...
                                            <div class="d-flex bd-highlight">
                                                <div class="flex-fill bd-highlight mr-3">
                                                    <img id="modalImage" src="" style="width: 300px; height: 160px;" title="teacher Logo" alt="logo">
                                                </div>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            $('#editTeacherModal').on('show.bs.modal', function(event) {
                ...
                modal.find('#modalFormX').attr('action', '/admin/teachers/' + id);
            ...
            function deleteTeacher(id) {
                if (confirm('Are you sure you want to delete this Teacher?')) {
                    $.ajax({
                        url: '{{ route('admin.teachers.destroy') }}',
                        type: 'DELETE',
                        data: {
                            id: id,
                        },
